...
func init() {
	ns := beego.NewNamespace("/v1/dy",
		beego.NSNamespace("/product",
			...
			beego.NSRouter("/words/:product_id", &v1dy.ProductController{}, "get:ProductWords"),
			beego.NSRouter("/base/:product_id", &v1dy.ProductController{}, "get:ProductBase"),
			beego.NSRouter("/comments/:product_id", &v1dy.ProductController{}, "get:ProductCommentTop"),
