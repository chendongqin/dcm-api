...
//
//const (
//	MQ_CMM_LOG_COMMON string = "CMM:QUENE:LOG:COMMON"
...
//	}
//	go ReportAli(MQ_CMM_LOG_COMMON, "chanmama-es-log", insertData)
//}
//
...
//		}
//	}
//	go ReportAli(MQ_CMM_LOG_COMMON, "chanmama-log-common", insertData)
//	return
//}
//
...
////定制log
////输入输出日志
//func LogInput(requestId string, clientId string, logType string, appId int, uid int64, url string, method string, ip string, useragent string, refer string, apidatas interface{}, userGroupId int, remote_addr string) {
//	var realUrl string
...
//	insertData["log_type"] = logType
//	insertData["appid"] = cdsutils.ParseString(appId)
//	insertData["uid"] = cdsutils.ParseStringInt64(uid)
//	insertData["group_id"] = cdsutils.ParseString(userGroupId)
...
//	insertData["args"] = ""
//	insertData["timestamp"] = cdsutils.ParseStringInt64(time.Now().Unix())
//	args, err := json.Marshal(apidatas)
//	if err == nil {
//		insertData["args"] = string(args)
//	}
//	go ReportAli(MQ_CMM_LOG_COMMON, "chanmama-log-api-history", insertData)
//}
//
////记录登录日志
...
//	insertData["useragent"] = useragent
//	go ReportAli(MQ_CMM_LOG_COMMON, "chanmama-log-user-active", insertData)
//}
//
