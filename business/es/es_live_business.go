...
//达人直播间搜索
func (receiver *EsLiveBusiness) SearchAuthorRooms(authorId, keyword string,hasProduct int, sortStr, orderBy string, page, size int, startDate, endDate time.Time) (list []es.EsDyLiveInfo, total int, comErr global.CommonError) {
	if sortStr == "" {
		sortStr = "create_time"
	}
	if orderBy == "" {
